...
import { idlFactory } from './fusion_swap_icp_backend.did.js';
export { idlFactory } from './fusion_swap_icp_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUSION_SWAP_ICP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fusion_swap_icp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fusion_swap_icp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fusion_swap_icp_backend.did.js")._SERVICE>}
 */
export const fusion_swap_icp_backend = createActor(canisterId);
