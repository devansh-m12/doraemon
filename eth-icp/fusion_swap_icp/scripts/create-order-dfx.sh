...
# Create Order using DFX CLI
# This script demonstrates how to create an order using dfx commands
...
echo "🚀 Creating Order using DFX CLI"
echo "=================================="
...
dfx canister call $ICRC1_CANISTER icrc2_approve "(record { from_subaccount = null; spender = record { owner = principal \"$FUSION_SWAP_CANISTER\"; subaccount = null }; amount = 5000000000 : nat; expires_at = null })"
...
dfx canister call $FUSION_SWAP_CANISTER create_order "(record { 
    ...
    dst_mint = principal \"$ICRC1_CANISTER\"; 
